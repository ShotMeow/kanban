...
export const ArrowIcon: FC<Props> = ({ width = '12px', height = '7px', ...props }) => {
  return (
    <svg width={width} height={height} viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
